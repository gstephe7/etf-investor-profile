          ...
          <div id="profile" className="container">
            ...
            <div className="row">
              <div className="col-xs-12">
                ...
                />
                <p>The Moderately Conservative Portfolio allocates 50% of its value in a Large-Cap Stock ETF, 30% of its value in an Intermediate-Term US Government Treasury ETF, and 20% in a Short-Term Government Treasury ETF. Large-cap stocks provide growth potential while offering a little more stability than small-cap stocks. An ETF that tracks the S&P 500 Index is suggested for the large-cap portion of the portfolio. The bond allocation of the moderately conservative portfolio is covered by a US Government Intermediate-Term Treasury ETF and a US Government Short-Term Treasury ETF. The intermediate-term treasury ETF is a little more volatile than the short-term treasury ETF, but intermediate-term treasuries usually provide higher returns. Government bonds stabilize the portfolio and protect against market downturns. </p>
              </div>
            </div>
            <div className="row">
              <div className="col-xs-12">
