          ...
          <div id="profile" className="container">
            ...
            <div className="row">
              <div className="col-xs-12">
                ...
                />
                <p>The Aggressive Portfolio allocates 50% of its value in a Small-Cap Stock ETF, 30% of its value in a Large-Cap Stock ETF, and 20% in an Intermediate-Term US Government Treasury ETF. Small-cap stocks provide the aggressive portfolio with a large amount of growth potential and upside. A Small-Cap Value ETF is preferred because small-cap value stocks have historically outperformed small-cap growth stocks. Large-cap stocks are included to provide diversification and a little more stability. An ETF that tracks the S&P 500 Index is suggested for the large-cap portion of the portfolio. The bond allocation of the aggressive portfolio is covered by a US Government Intermediate-Term Treasury ETF. Government bonds balance out the portfolio and provide some protection against market downturns. </p>
              </div>
            </div>
            <div className="row">
              <div className="col-xs-12">
