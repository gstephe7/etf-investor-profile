          ...
          <div id="profile" className="container">
            ...
            <div className="row">
              <div className="col-xs-12">
                ...
                />
                <p>The Balanced Portfolio allocates 40% of its value in a Large-Cap Stock ETF, 20% of its value in a Small-Cap Stock ETF, and 40% in an Intermediate-Term US Government Treasury ETF. Large-cap stocks provide growth potential while offering a little more stability than small-cap stocks. An ETF that tracks the <a href="http://money.cnn.com/data/markets/sandp/" target="_blank" rel="noopener noreferrer">S&P 500 Index</a> is suggested for the large-cap portion of the portfolio. A cautious allocation toward small-cap stocks provide the portfolio with some extra growth potential and upside. A Small-Cap Value ETF is preferred because small-cap <a href="http://www.investopedia.com/terms/v/valuestock.asp?lgl=rira-baseline-vertical" target="_blank" rel="noopener noreferrer">value stocks</a> have historically outperformed small-cap <a href="http://www.investopedia.com/terms/g/growthstock.asp?lgl=rira-baseline-vertical" target="_blank" rel="noopener noreferrer">growth stocks</a>. The bond allocation of the balanced portfolio is covered by a US Government Intermediate-Term Treasury ETF. Government bonds balance out the portfolio and provide protection against market downturns. </p>
              </div>
            </div>
            <div className="row">
              <div className="col-xs-12">
